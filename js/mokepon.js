...
document.getElementById("nueva_mascota").addEventListener("click", crearMascota)

function crearMascota() {
    let nombre = prompt("ingrese un nombre")
    let nuevaMascota = new Mokepon(nombre.toString(), './assets/mokepons_mokepon_ratigueya_attack.png', 5, './assets/ratigueya.png') 
    mokepones.push(nuevaMascota)
}
